...
//            Log.d(String.valueOf(environment.getConfig().getEmbeddedYoutubeConfig().isYoutubeEnabled()),"Config");
            if (apiKey == null || apiKey.isEmpty()) {
//                Log.d(String.valueOf(apiKey)
//                        ,"Api Key Value");
                return;
            }
    ...
    private void loadTranscriptsData(VideoBlockModel unit) {
        ...
        Log.d(String.valueOf(unit.getDownloadEntry(environment.getStorage())),"EID2");
        TranscriptModel transcript = getTranscriptModel(unit.getDownloadEntry(environment.getStorage()));
        Log.d(String.valueOf(transcript),"Transcript");
