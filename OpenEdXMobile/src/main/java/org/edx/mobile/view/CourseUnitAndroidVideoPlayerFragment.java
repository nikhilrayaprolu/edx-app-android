...
public class CourseUnitAndroidVideoPlayerFragment extends CourseUnitVideoFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        if(extraIntent != null)
        {
            ...
            if(lecture == null)
            {
                lecture = (LectureModel)extraIntent.getSerializableExtra("lecture");
            }

            // read incoming enrollment model
            if(enrollment == null)
            {
                enrollment = (EnrolledCoursesResponse)extraIntent.getSerializableExtra(Router.EXTRA_COURSE_DATA);
            }
    ...
    public synchronized void playVideoModel(final DownloadEntry video) {
        ...
        try{
            ...
            Log.d(String.valueOf(video.eid),"EID");
...
//    {
//        super.initTranscriptListView();
//        transcriptListView.setOnItemClickListener(new View.OnClickListener(){
//            @Override
//            public void onClick(View v)
//            {
//                final Caption currentCaption = transcriptAdapter.getItem(position);
